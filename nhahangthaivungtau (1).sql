...
--
-- Host: localhost:3306
-- Generation Time: May 04, 2025 at 03:09 AM
...
('laravel_cache_livewire-rate-limiter:a17961fa74e9275d529f489537f179c05d50c2f3', 'i:1;', 1746322648),
('laravel_cache_livewire-rate-limiter:a17961fa74e9275d529f489537f179c05d50c2f3:timer', 'i:1746322648;', 1746322648);
...
CREATE TABLE `foods` (
  ...
  `best_seller_banner` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(10, '127.0.0.1', '2025-05-03 20:08:56', '2025-05-03 20:08:49', '2025-05-03 20:08:56');
...
('Dxr3XfKUcFZkQeKdQce5ltJj6Y6bKOxOT6HgYVm6', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/135.0.0.0 Safari/537.36', '', 1746328136);
