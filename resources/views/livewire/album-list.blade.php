<div>
    ...
    <head>
        ...
        <title>Album ảnh - {{ \App\Models\Setting::first()->web_name }}</title>
    ...
    <body>
        ...
        <div id="container" class="center w-clear">
            <div class="title-main">
                <h1 style="font-family: 'Lodestone', sans-serif;">Album ảnh</h1>
                <p></p>
            </div>
            <div class="w-clear">
        ...
        <script type="text/javascript"
            src="{{ asset('assets/simplyscroll/jquery.simplyscroll.js?v=u3MEXq1L9S') }}"></script>
        ...
        <script type="text/javascript"
            src="{{ asset('assets/datetimepicker/php-date-formatter.min.js?v=qOcT2GqDW7') }}">
            </script>
        <script type="text/javascript"
            src="{{ asset('assets/datetimepicker/jquery.mousewheel.js?v=cFgHl0wzdt') }}"></script>
        ...
        <script type="text/javascript"
            src="{{ asset('assets/js/jquery.pixelentity.shiner.min.js?v=QV8qj3CKJT') }}"></script>
